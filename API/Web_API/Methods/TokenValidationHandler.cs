...
namespace tms_acl_api.Methods
{
    public class TokenValidationHandler : DelegatingHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                string securityCode = ConfigurationManager.AppSettings["JWTSecurityKey"].ToString();
                //const string sec = securityCode;
                ...
                {
                    ValidAudience = ConfigurationManager.AppSettings["JWTAudience"].ToString(),
                    ValidIssuer = ConfigurationManager.AppSettings["JWTIssuer"].ToString(),
